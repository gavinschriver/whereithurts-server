"""
Django settings for whereithurts project.
...
SECRET_KEY = 'h1j2*^2vk8fi%cx98k$q@r&a9)b-5-ck&^fpw$*4yf#pgb3us5'
...
ROOT_URLCONF = 'whereithurts.urls'
...
WSGI_APPLICATION = 'whereithurts.wsgi.application'
